(function () {
  ...
  function init() {
    ...
    Worksheet.make('wsBox', {
      ...
      fields: [
        { id: 'a1', label: '① 使っているサービス', hint: 'SNS・ゲーム・通販・学習アプリなど、ひとつ選ぶ。', rows: 2, ph: '例：写真を投稿するSNS' },
        { id: 'a2', label: '② 登録時に渡した情報', hint: '名前・生年月日・メール・電話番号・顔写真など。', rows: 3,
          ph: '例：メールアドレス、生年月日、プロフィール写真' },
        { id: 'a3', label: '③ 使ううちに渡している情報', hint: '位置情報、閲覧履歴、友だち関係、投稿の時間帯など。', rows: 3,
          ph: '例：投稿した場所、いつ起きているかが分かる投稿時刻' },
        { id: 'a4', label: '④ そこから何が推測できるか', hint: '単体では平気でも、組み合わせると個人が特定できることがある。', rows: 3,
          ph: '例：制服＋最寄り駅＋部活の時間から、通学経路と学校が分かる' },
        { id: 'a5', label: '⑤ 見直したい設定・行動', hint: '公開範囲、位置情報のオフ、投稿を遅らせるなど。', rows: 3,
          ph: '例：位置情報をオフにする／写真は帰宅後に投稿する' }
      ],
      build: function (v, e) {
        return '<h4>個人情報の棚おろしシート</h4><dl>' +
          '<dt>① サービス</dt><dd>' + e(v.a1) + '</dd>' +
          '<dt>② 登録時に渡した情報</dt><dd>' + e(v.a2) + '</dd>' +
          '<dt>③ 使ううちに渡している情報</dt><dd>' + e(v.a3) + '</dd>' +
          '<dt>④ 組み合わせると分かってしまうこと</dt><dd>' + e(v.a4) + '</dd>' +
          '<dt>⑤ 見直したい設定・行動</dt><dd>' + e(v.a5) + '</dd></dl>';
      },
      note: '④が書けたら、この節のねらいは達成です。ここに書いた内容は他の人に見せなくてかまいません。'
    });
